...
public final class ModBlockTagsProvider extends BlockTagsProvider {
	...
	private void addOreTags() {
		...
		tag(BlockTags.MINEABLE_WITH_PICKAXE)
			...
			.add(OreBlocks.DEEPSLATE_SILVER_ORE.get())
			.add(OreBlocks.NETHERRACK_CITRINE_ORE.get())
			.add(OreBlocks.CITRINE_BLOCK.get())
			.add(OreBlocks.CITRINE_BRICKS.get())
			.add(OreBlocks.CITRINE_PILLAR.get())
			.add(OreBlocks.CITRINE_SLAB.get())
			.add(OreBlocks.CITRINE_STAIRS.get())
			.add(OreBlocks.CHISELED_CITRINE_BLOCK.get())
			.add(OreBlocks.SMOOTH_CITRINE.get())
			.add(OreBlocks.SMOOTH_CITRINE_SLAB.get())
			.add(OreBlocks.SMOOTH_CITRINE_STAIRS.get())
			.add(OreBlocks.NETHERRACK_AVENTURINE_ORE.get())
